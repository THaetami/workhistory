        ...
        <>
            <div className="content">
                <div className="content-wrap">
                    <div className="content-title">{ started } - { ended ? ended : 'Current' }</div>
                    <div className="wrap-body">
                        <div className="wrap-setting">
                            <div className="setting-button">
                            <button aria-label="delete" onClick={() => setOpenModal(true)} className="button-custom">
                            ...
                            <div className="setting-button">
                            <button aria-label="update" onClick={handleUpdateWorkById}  className="button-custom">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" height="24" width="24">
